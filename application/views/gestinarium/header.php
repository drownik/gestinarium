...
<html class="wide wow-animation" lang="es">
  <head>
    <!-- Site Title-->
    <title>Clinica Paguera - Gestinarium</title>
		              ...
		              <div class="rd-navbar-main">
		                ...
		                <div class="rd-navbar-nav-wrap">
		                	<div class="rd-navbar-main-item">
	                  			<a class="button button-xs button-primary" href="<?php echo base_url('login/logout'); ?>"><span class="icon icon-md fa-power-off"></span> Cerrar sesión</a>
	                  		</div>
		                  <!-- RD Navbar Nav-->
		                  <ul class="rd-navbar-nav">
		                    <li class="active">
		                    	<a href="<?php echo base_url('gestinarium'); ?>">Home</a>
		                    </li>
		                    <li>
		                    	<a href="<?php echo base_url('gestinarium/fichas'); ?>">Fichas mascotas</a>
		                    </li>
		                    <li>
		                    	<a href="<?php echo base_url('gestinarium/clientes'); ?>">Fichas clientes</a>
		                    </li>
		                    <li>
		                    	<a href="<?php echo base_url('gestinarium/consultas'); ?>">Informes consultas</a>
		                    </li>
		                  </ul>
		                </div>
		              </div>
